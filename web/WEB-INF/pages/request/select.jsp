...
<head>
    ...
    <%
        ...
        List<String> names = map.get(type.replace("需求", "服务"));

    %>
    <title>筛选<%out.print(type);%></title>
</head>
<body>
...
<div class="weui-tab">
    <div class="weui-tab__panel">
        <div class="weui-panel__hd">
            <span>筛选<span class="select-title"><%out.print(type);%></span></span>
        </div>
            ...
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_text" style="padding-bottom: 25px">
                    <div style="margin-left: 15px">
                        <span style="color:#76b852">需求类型</span>
                        <%
                ...
                <div class="weui-media-box weui-media-box_text">
                    <div style="margin-left: 15px">
                        <span style="color:#76b852">需求时间</span>
                ...
                <div class="weui-media-box weui-media-box_text" style="padding-bottom: 25px">
                    <div style="margin-left: 15px">
                        <span style="color:#76b852">需求金额</span>
                        <div class="range-slider"></div>
                    </div>
                </div>
                <div class="weui-media-box weui-media-box_text" style="padding-bottom: 25px">
                    <div style="margin-left: 15px; margin-top: 20px;margin-bottom: 30px; float:right">
                        <a class="weui-btn weui-btn_mini weui-btn_default" href="${pageContext.request.contextPath}/request/list?type=<%out.print(request.getAttribute("type"));%>">取消</a>
    ...
    <script>
        ...
        $('#select-confirm').click(function(){
            var type = "<%out.print(request.getAttribute("type"));%>";
            var serviceName = "";
            var i =0;
