                    ...
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
                            <div class="weui-flex">
                                ...
                                <div class="weui-flex__item"display="none"></div>
                                <div class="weui-flex__item"display="none"></div>
                                <div class="weui-flex__item"> <a class="weui-btn weui-btn_mini weui-btn_primary" href="${pageContext.request.contextPath}<%out.print("/user/applyUserStartPay?recordID="+requestToPay.get(i).getId());%>">支付</a></div>
                            </div>
                        </div>
                    </div>
                </div>
