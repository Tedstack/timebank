...
<div class="weui-cells weui-cells_form">
    ...
    <div class="weui-cell">
        ...
        <div class="weui-cell__bd">
            <input class="weui-input" id="team_name" placeholder="输入团队名称">
        </div>
    </div>
    <%--<div class="weui-cell">--%>
        <%--<div class="weui-cell__hd"><label class="weui-label">地点</label></div>--%>
        <%--<div class="weui-cell__bd">--%>
            <%--<input class="weui-input" id="team_location" placeholder="输入团队主要活动地点"/>--%>
        <%--</div>--%>
    <%--</div>--%>
    <div class="weui-cells weui-cells_form">
        <div class="weui-cell weui-cell_switch">
            ...
            <div class="weui-cell__ft">
                <input class="weui-switch" id="is_public" type="checkbox">
            </div>
        </div>
    </div>
    <div class="weui-cell">
    ...
    <div style="text-align:center;">
        <textarea id="describe" rows="10" cols="30" placeholder=".... " maxlength=200 style="width:250px; height:180px; border:solid 1px #4d4d4d;resize:none; font-size: 16px; padding:3px;border-radius: 1px;"></textarea>
    </div>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#create").on('click', function () {
            ...
            var isPublicButton=document.getElementById("is_public");
            var isPublic="false";
            ...
            $.ajax({
                ...
                cache: false,
                url: targetUrl,
                data: "teamName="+teamName+"&isPublic="+isPublic+"&describe="+describe,
