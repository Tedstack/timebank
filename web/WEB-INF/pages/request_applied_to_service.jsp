                    ...
                    <div class="weui-media-box weui-media-box_appmsg">
                        ...
                        <div class="weui-media-box__bd">
                            ...
                            <p class="weui-media-box__desc">结束时间
                                ...
                                %></p>
                            <p class="weui-media-box__desc">服务地点: <%out.print(matchDetailList.get(i).getAddress());%></p>
                            <p class="weui-media-box__desc">订单状态:  <%
                                if(matchDetailList.get(i).getActualBeginTime()==null){
                                    out.print("已确认");
                                }else if(matchDetailList.get(i).getActualEndTime()==null){
                                    out.print("开始服务");
                                }else{
                                    out.print("结束服务");
                                }
                            ...
                            <ul class="weui-media-box__info">
                                <li class="weui-media-box__info__meta"><%out.print(matchDetailList.get(i).getRequestUserName());%></li>
                                <li class="weui-media-box__info__meta weui-media-box__info__meta_extra"><%out.print(matchDetailList.get(i).getRequestUserPhone());%></li>
                            </ul>
                        </div>
                    </div>
                    <div class="weui-cell">
                        <div class="weui-cell__bd">
                            <div class="weui-flex">
                                ...
                                <div class="weui-flex__item"display="none"></div>
                                <div class="weui-flex__item"display="none"></div>
                                <div class="weui-flex__item"><a href="${pageContext.request.contextPath}/user/requestApplyUserStartScan?matchID=<%out.print(matchDetailList.get(i).getId());%>" class="weui-btn weui-btn_mini weui-btn_primary">扫码</a></div>
                            </div>
                        </div>
                    </div>
