...
<div class="weui-msg">
    ...
    <div class="weui-msg__text-area">
        ...
        <p class="weui-msg__desc">等待服务提供者确认<a href="${pageContext.request.contextPath}/user/queryOrderAlreadyApply">查看我的订单</a></p>
    </div>
    <div class="weui-msg__opr-area">
        <p class="weui-btn-area">
            <a href="${pageContext.request.contextPath}/publish/list?type=志愿者服务" class="weui-btn weui-btn_primary">返回首页</a>
        </p>
    </div>
</div>
