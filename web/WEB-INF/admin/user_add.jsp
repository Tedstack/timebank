                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>身份证号</label>
                                            <input class="form-control" type="text" id="idCard" name="idCard" placeholder="请输入身份证号" required>
                                        </div>
                                        <div class="form-group">
                                            <label>性别</label> <br>
                                        ...
                                        <div class="form-group">
                                            <label>出生年月</label>
                                            <input class="form-control" type="date" id="birth" name="birth" placeholder="请输入出生年月" required>
                                        </div>
                                        <div class="form-group">
                                            <label>卡号</label>
                                            <input class="form-control" type="text" name="QRCode" placeholder="请输入要绑定的卡号">
                                        </div>
