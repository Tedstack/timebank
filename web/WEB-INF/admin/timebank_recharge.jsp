...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">账户充值</li>
        </ol>
        <!-- Area Chart Example-->
        <div class="card mb-3">
            <div class="card-header">
                <i class="fa fa-fw fa-bank"></i> 账户资料
            </div>
            <div class="card-body">
                <%
                    ...
                    ViewTimebankDetailEntity viewTimebankDetailEntity = (ViewTimebankDetailEntity) request.getAttribute("viewTimebankDetailEntity");
                %>

                <form action="${pageContext.request.contextPath}/admin/timebankRechargeSubmit" method="post">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <button type="submit" style="margin-top: 10px;" class="btn btn-primary btn-block">充值</button>
                                    </div>
                                </div>
                            </div>
